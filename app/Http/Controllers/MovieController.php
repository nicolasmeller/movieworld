...
class MovieController extends Controller
{
    ...
    public function IndexHot()
    {
        ...
        $collection = Http::get("https://api.themoviedb.org/3/movie/popular?api_key=$key&language=en-US&page=1%22") -> json();
    ...
    public function Index(){
        $key = config('app.movieapi');
        $hotmovies = Http::get("https://api.themoviedb.org/3/movie/popular?api_key=$key&language=en-US&page=1%22") -> json();
        $upcomingmovies = Http::get("https://api.themoviedb.org/3/movie/upcoming?api_key=$key&language=en-US&page=1%22") -> json();
        $topratedmovies = Http::get("https://api.themoviedb.org/3/movie/top_rated?api_key=$key&language=en-US&page=1") -> json();
